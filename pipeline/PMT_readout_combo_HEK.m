...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    analysis_params.Peak_length = 400; % estimated peak length
    ...
    analysis_params.detect_thresh_pmt(3) = 30;
    ...
    analysis_params.thresh_base_height_range = 0.03;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
else
...
%% generate analysis params txt files and baseline fluctuation report plot
cd(input_info.pmt_dir{1})
...
if nargin ~=0
    cd(output_dir)
        figure('color','w','Position',[744,630,441,353])
        scatter(full_readout_pmt.time_of_detection(:),full_readout_pmt.baseline(:,fxm_channel)...
            ,5,'filled',"MarkerFaceAlpha",0.5)
        hold on
        scatter(full_readout_pmt.time_of_detection(cell_pass_ind),full_readout_pmt.baseline(cell_pass_ind,fxm_channel)...
